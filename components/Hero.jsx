        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-3/4 text-center lg:text-left">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto lg:mx-0">
              Trusted architectural design and construction experts in
              Jharkhand, creating homes that match your needs, lifestyle, and
              budget.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button
                ...
                className="bg-primary hover:bg-primary/90 text-primary-foreground py-2.5 px-8"
              >
              ...
              <Button
                ...
                className="border-primary text-primary py-2.5 px-8"
              >
