        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mx-auto">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="https://www.instagram.com/bhuvi.homes" target="_blank" aria-label="Follow BhuviHomes on Instagram">
              ...
              <Link href="https://www.facebook.com/people/Bhuvi-Homes/61572994662720/" target="_blank" aria-label="Follow BhuviHomes on Facebook">
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Facebook</title><path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 26.805 26.805 0 0 0-.733-.009c-.707 0-1.259.096-1.675.309a1.686 1.686 0 0 0-.679.622c-.258.42-.374.995-.374 1.752v1.297h3.919l-.386 2.103-.287 1.564h-3.246v8.245C19.396 23.238 24 18.179 24 12.044c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.628 3.874 10.35 9.101 11.647Z"/></svg>
              </Link>
              <Link href="https://x.com/BhuviHomes" target="_blank" aria-label="Follow BhuviHomes on X (formerly Twitter)">
              ...
              <Link href="https://www.linkedin.com/in/bhuvi-homes-02215a358/" target="_blank" aria-label="Follow BhuviHomes on LinkedIn">
              ...
              <Link href="https://youtube.com/@bhuviconsultants" target="_blank" aria-label="Follow BhuviHomes on YouTube">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <ul className="space-y-2">
                <li>
                  <Link href="/" className="text-gray-500 hover:text-green-700" aria-label="Go to BhuviHomes homepage">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/about" className="text-gray-500 hover:text-green-700" aria-label="Learn more about BhuviHomes">

                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/blogs" className="text-gray-500 hover:text-green-700" aria-label="Read BhuviHomes blogs about home design and construction in Jharkhand">
                    Blogs
                  </Link>
                </li>
                <li>
                  <Link href="/projects" className="text-gray-500 hover:text-green-700" aria-label="View BhuviHomes projects in Jharkhand">
                    Projects
                  </Link>
                </li>
              </ul>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/how-it-works" className="text-gray-500 hover:text-green-700" aria-label="Learn how BhuviHomes works">
                    How It Works
                  </Link>
                </li>
                <li>
                  <Link href="/faqs" className="text-gray-500 hover:text-green-700" aria-label="View BhuviHomes FAQs">
                    FAQs
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-gray-500 hover:text-green-700" aria-label="Get a quote from BhuviHomes">
                    Get a Quote
                  </Link>
                </li>
              </ul>
